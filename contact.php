	...
	if($_GET['id']) {
		...
		if($_GET['mod']) {
			...
			while($row = mysql_fetch_array($result3, MYSQL_ASSOC)) {
				...
				$contact_methods["label"][]   = '<img src="images/building.png" alt="address" /> ' . $row["addr_label"];
			...
			while($row = mysql_fetch_array($result4, MYSQL_ASSOC)) {
				...
				$contact_methods["label"][]   = '<img src="images/e-mail.png" alt="e-mail" /> ' . $row["eml_label"];
			...
			while($row = mysql_fetch_array($result5, MYSQL_ASSOC)) {
				...
				$contact_methods["label"][]   = '<img src="images/phone.png" alt="phone" /> ' . $row["pho_label"];
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <script type="text/javascript" src="js/spousesearch.js"></script>
		<link rel="stylesheet" href="http://yui.yahooapis.com/2.5.1/build/reset-fonts-grids/reset-fonts-grids.css" type="text/css" />
		<link rel="stylesheet" href="css/spousesearch.css" type="text/css" />
								...
								<div class="yui-g content">
									<div>
										<div class="personal-left">
											...
											<div>&nbsp;</div>
											<div>
												<label for="spousesearch">Spouse:</label>
												<div>
													<div><input type="text" class="name" name="spouse" id="spousesearch" value="$spousename" /></div>
													<div class="spousesearch"><div id="spousesearch_results" class="spousesearch_results"></div></div>
												</div>
											</div>
											</form>
										</div>
